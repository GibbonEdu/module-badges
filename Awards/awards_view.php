...
if (isActionAccessible($guid, $connection2, "/modules/Awards/awards_view.php")==FALSE) {
	...
	print "<div class='trailHead'><a href='" . $_SESSION[$guid]["absoluteURL"] . "'>" . __($guid, "Home") . "</a> > <a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . getModuleName($_GET["q"]) . "/" . getModuleEntry($_GET["q"], $connection2, $guid) . "'>" . __($guid, getModuleName($_GET["q"])) . "</a> > </div><div class='trailEnd'>" . __($guid, 'View Awards') . "</div>" ;
	print "</div>" ;
	...
	if ($highestAction==FALSE) {
		...
		if ($highestAction=="View Awards_all") {
				...
				<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
					...
					<tr>
						<td colspan=2 class="right">
							<input type="hidden" name="q" value="/modules/<?php print $_SESSION[$guid]["module"] ?>/awards_view.php">
		...
		else if ($highestAction=="View Awards_my") {
			$output="" ;
			print "<h2>" ;
			print __($guid, "My Awards") ;
			print "</h2>" ;
			...
			if ($result->rowCount()!=1) {
				...
				print getAwards($connection2, $guid, $_SESSION[$guid]["gibbonPersonID"]) ;
			}
		}
		else if ($highestAction=="View Awards_myChildren") {
			$gibbonPersonID=NULL ;
						...
						<table class='noIntBorder' cellspacing='0' style="width: 100%">	
							...
							<tr>
								<td colspan=2 class="right">
									...
									<?php
									print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/awards_View.php'>" . __($guid, 'Clear Search') . "</a>" ;
									?>
									<input type="submit" value="<?php print __($guid, "Submit") ; ?>">
								</td>
							</tr>
