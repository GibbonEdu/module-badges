		...
		if ($result->rowCount()!=1) {
			...
			if ($_GET["gibbonPersonID2"]!="" OR $_GET["awardsAwardID2"]!="") {
				print "<div class='linkTop'>" ;
					print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/Awards/awards_grant.php&gibbonPersonID2=" . $_GET["gibbonPersonID2"] . "&awardsAwardID2=" . $_GET["awardsAwardID2"] . "&gibbonSchoolYearID=$gibbonSchoolYearID" . "'>" . __($guid, 'Back to Search Results') . "</a>" ;
				print "</div>" ;
			}
			?>
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/awards_grant_deleteProcess.php?awardsAwardStudentID=$awardsAwardStudentID&gibbonPersonID2=" . $_GET["gibbonPersonID2"] . "&awardsAwardID2=" . $_GET["awardsAwardID2"] . "&gibbonSchoolYearID=$gibbonSchoolYearID" ?>">
