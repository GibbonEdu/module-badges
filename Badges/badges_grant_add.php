		...
		<table class='smallIntBorder' cellspacing='0' style="width: 100%">
			<tr>
				<td style='width: 275px'>
					...
					<span style="font-size: 90%"><i><?php echo __('Use Control, Command and/or Shift to select multiple.') ?> </span>
				</td>
				<td class="right">
					<select multiple name="gibbonPersonIDMulti[]" id="gibbonPersonIDMulti[]" style="width: 302px; height:150px">
						...
						<optgroup label='--<?php echo __('All Users') ?>--'>
							<?php
                            try {
                                $dataSelect = array();
			...
			<tr>
				...
				<td class="right">
					...
					<script type="text/javascript">
						...
						badgesBadgeID.add(Validate.Exclusion, { within: ['Please select...'], failureMessage: "<?php echo __('Select something!') ?>"});
					</script>
				</td>
			</tr>
			<tr>
				<td>
					...
					<span style="font-size: 90%"><i><?php echo __('Format:') ?> <?php if ($_SESSION[$guid]['i18n']['dateFormat'] == '') {
						echo 'dd/mm/yyyy';
					} else {
